...
public class SoundData
{
    ...
    private static void InstantiateSoundEffect()
    {
        ...
        _soundEffect.Add(SoundEffectName.UI_CHARACTER_POP, Resources.Load<AudioClip>("SoundDesign/UI/UI_Beep_Double_Quick_Bright_Short_stereo"));
        ...
        _soundEffect.Add(SoundEffectName.PLAYER_LAND, Resources.Load<AudioClip>("SoundDesign/Player/FOOTSTEP_Leather_Wood_Hollow_Land_RR7_mono"));
